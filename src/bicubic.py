...
parser.add_argument('-p', '--path', default='/content/SRCNN-Train/input/Set14/original', 
                    nargs='+',
...
if args['scale_factor'] == '3x':
    scale_factor = 0.333
    os.makedirs('/content/SRCNN-Train/input/test_bicubic_rgb_3x', exist_ok=True)
    os.makedirs('/content/SRCNN-Train/input/test_hr', exist_ok=True)
    save_path_lr = '/content/SRCNN-Train/input/test_bicubic_rgb_3x'
    save_path_hr = '/content/SRCNN-Train/input/test_hr'
if args['scale_factor'] == '4x':
    scale_factor = 0.25
    os.makedirs('/content/SRCNN-Train/input/test_bicubic_rgb_4x', exist_ok=True)
    os.makedirs('/content/SRCNN-Train/input/test_hr', exist_ok=True)
    save_path_lr = '/content/SRCNN-Train/input/test_bicubic_rgb_4x'
    save_path_hr = '/content/SRCNN-Train/input/test_hr'
